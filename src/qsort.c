...
void
swap (void *a, void *b, size_t item_size)
{
    char tmp[item_size];
...
int
partition (void *orig_arr, size_t item_size, size_t low, size_t high,
...
void
quicksort (void *orig_arr, size_t item_size, size_t low, size_t high,
           int (*compare) (const void *, const void *))
{
    if (low < high)
        {
...
void
qsort (void *orig_arr, size_t item_size, size_t arr_size,
       int (*compare) (const void *, const void *))
{
